...
> = {
  ANDSuffix: AS;
    ...
    ? {
      extraExpressionAttributeNames: Record<SAEAs['ean'], GetAllKeys<TypeOfItem>>;
    } : {
    ...
    ? {
      extraExpressionAttributeValues: Record<SAEAs['eav'], any>;
    } : {
...
> = {
  ...
  * ```
  */
  extraConditions?: ExtraConditions<AS, TypeOfItem>;
  /**
